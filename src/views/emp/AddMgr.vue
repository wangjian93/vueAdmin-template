<template>
  <div class="app-container" style="margin-top: -20px;">
    <el-form  :model="empForm" :rules="rules" ref="empForm" label-position="left" label-width="100px" style="margin:10px 10px 10px 10px;">
      <el-form-item>
        ...
        <el-row :gutter="80" style="margin:5px 0px 10px 20px;">
          <el-col :span="8">
            <el-form-item label="工号"  prop="empNo">
              <el-input v-model="empForm.empNo" :disabled="true"></el-input>
            </el-form-item>
...
<script>
  ...
  import { saveEmp, createFamily } from '@/api/mgr';
...
//        });
      ...
      formSubmit( formName ) {
        var flag
          ...
          if(flag) {
            saveEmp(this.empForm).then(response => {
              this.$message({
                message: '保存成功',
                type: 'success'
              })
...
//          });
      ...
      handleAvatarSuccess(res, file) {
        ...
        this.empForm.imageUrl = 'api/SpringMVC006/image?fileName=' + res.fileName
      },
